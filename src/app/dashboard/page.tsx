        ...
        <div className="min-h-screen p-4 sm:p-6 lg:p-8 relative flex flex-col">
            ...
            <header className="mb-8 sm:mb-12 flex justify-between items-start relative z-10 animate-slide-up">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a
                        href="/settings"
                        className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[var(--text-tertiary)] hover:text-white hover:bg-white/10 hover:border-white/20 transition-all"
                        title="Settings"
                    >
